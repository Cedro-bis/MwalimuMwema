...
const App = () => {
  ...
  // --- SEO / GEO / AEO — Métadonnées dynamiques selon la vue active ---
  const seoConfig = (() => {
    switch (view) {
      case 'curriculum':
        return curriculum
          ? SEO_CONFIGS.curriculum(curriculum.subject, curriculum.level)
          : SEO_CONFIGS.onboarding;
      case 'lesson':
        return activeChapter && curriculum
          ? SEO_CONFIGS.lesson(activeChapter.title, curriculum.subject)
          : SEO_CONFIGS.onboarding;
      case 'quiz':
        return activeChapter
          ? SEO_CONFIGS.quiz(activeChapter.title)
          : SEO_CONFIGS.onboarding;
      case 'news':
        return SEO_CONFIGS.news;
      case 'profile':
        return SEO_CONFIGS.profile;
      case 'onboarding':
      default:
        return SEO_CONFIGS.onboarding;
    }
  })();
  ...
  return (
    <div className="min-h-screen bg-white text-black font-sans selection:bg-black selection:text-white">
      ...
      {/* SEO/GEO/AEO — Données structurées JSON-LD dynamiques */}
      <StructuredData
        view={view}
